...
namespace Normal.Realtime
{
    ...
    public class NetworkedAvatar : RealtimeComponent<RealtimeAvatarModel>
    {
        // Local Player
        [Serializable]
...
#pragma warning restore 0649
        ...
        private NetworkedPlayerManager _networkedPlayerManager;
      ...
      //  private static List<XRNodeState> _nodeStates = new List<XRNodeState>();
        ...
        void Start()
        {
            ...
            try
            {
                _networkedPlayerManager = realtime.GetComponent<NetworkedPlayerManager>();
                _networkedPlayerManager._RegisterAvatar(realtimeView.ownerIDSelf, this);
            }
        ...
        void OnDestroy()
        {
            ...
            if (_networkedPlayerManager != null)
                _networkedPlayerManager._UnregisterAvatar(this);
        ...
        void SetLocalPlayer(LocalPlayer localPlayer)
        {
            ...
            if (_localPlayer != null)
            {
                ...
                if (_localPlayer.leftHand != null) leftHand.GetChild(0).gameObject.SetActive(false);
                if (_localPlayer.rightHand != null) rightHand.GetChild(0).gameObject.SetActive(false);
            }
        ...
        void UpdateAvatarTransformsForLocalPlayer()
        {
            ...
            return; //No need for VR syncing in this file
